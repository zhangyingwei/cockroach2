 ...
 * @desc:
 */
public class ExecutorRunningListener implements ICListener<String> {
    private final CockroachConfig config;

    public ExecutorRunningListener(CockroachConfig config) {
        this.config = config;
    }
    ...
    public ListenerType type() {
        return ListenerType.EXECUTOR_RUNNING;
    }
}
