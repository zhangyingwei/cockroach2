...
import com.zhangyingwei.cockroach2.common.exception.CockroachException;
...
public class Task implements Comparable<Task> {
    ...
    public CockroachRequest toRequest() throws CockroachUrlNotValidException {
        if (null == url) {
            throw new CockroachUrlNotValidException(url);
        }
        return CockroachRequest.builder()
                .url(this.url)
                .params(this.params)
